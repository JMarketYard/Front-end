    ...
    <FooterContainer>
      <FooterContent>
        ...
        <InfoSection>
          <InfoBlock>
            ...
            <Line>대표 : 송유림 ㅣ 사업자등록번호 : 307-43-01173</Line>
            <Line>통신판매업신고 : 0000-경기김포-0000</Line>
            <Line>호스팅서비스 제공자 : Amazon Web Services (AWS)</Line>
          </InfoBlock>
          <InfoBlock>
            <Spacer />
            <Line>EMAIL : jangmadang2025@gmail.com ㅣ FAX : 000-0000-0000</Line>
      ...
      <FooterContent>
        <FooterBottom>
          <Notice>
            <Line>
              장마당은 온라인 거래를 중개하는 플랫폼으로서, 직접 상품을 판매하는
              사업자가 아닙니다. 따라서, 전자상거래 등에서의 소비자 보호에 관한
              법률 및 장마당의 이용 약관에 따라,
            </Line>
            <Line>
              상품의 등록, 정보 제공, 거래 및 그로 인한 책임은 모두 개별
              판매자에게 귀속됩니다. 장마당은 회원 간 이루어지는 거래에 대해
              직접적인 책임을 부담하지 않으며, 거래 과정에서
            </Line>
            <Line>
